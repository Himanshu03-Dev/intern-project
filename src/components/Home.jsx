  ...
  return (
    <>
      <div className="home" id="home">
        <main>
          <h1>CodewithDev </h1>
          <p>Programming isn't about what you know; </p>
          <p> it's about what you can figure out.</p>
        </main>
      </div>
      ...
      <div className="home2">
        ...
        <div>
          <p>
          Programming refers to a technological process for telling a computer
           which tasks to perform in order to solve problems. You can think of programming
            as a collaboration between humans and computers, 
          in which humans create instructions for a computer to 
